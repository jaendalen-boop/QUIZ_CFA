            ...
            "questions": [
                {
                    ...
                    "correction": " Pour calculer le montant de la taxe (TVA), on multiplie le Prix Hors Taxe par le taux exprimé sous forme décimale. Calcul : 100 € x 0,20 = 20 €. Le montant de la TVA s'ajoute ensuite au prix HT pour donner le prix TTC."
                },
                {
                    "questionNumber": 2,
                    ...
                    "correction": " Le Prix Toutes Taxes Comprises (TTC) représente le montant total payé par le client. Il est égal à la somme du Prix Hors Taxe (HT) et de la Taxe sur la Valeur Ajoutée (TVA). Formule : TTC = HT + TVA."
                },
                {
                    "questionNumber": 3,
                    ...
                    "correction": " Pour trouver le montant d'une remise, on multiplie le prix initial par le pourcentage de réduction. Calcul : 50 € x (10/100) = 50 x 0,10 = 5 €. Le nouveau prix sera de 45 € (50 - 5)."
                },
                {
                    "questionNumber": 4,
                    ...
                    "correction": " Le prix Hors Taxes (HT) est le prix d'un produit ou d'un service avant l'application des taxes gouvernementales (TVA). C'est la base de calcul utilisée par les professionnels entre eux."
                },
                {
                    "questionNumber": 5,
                    ...
                    "correction": " On utilise la formule inverse du TTC. Puisque TTC = HT + TVA, alors HT = TTC - TVA. Calcul : 60 € - 10 € = 50 €."
                },
                {
                    "questionNumber": 6,
                    ...
                    "correction": " Pour calculer un prix total, on effectue une multiplication simple de la quantité par le prix unitaire. Calcul : 3 x 12 € = 36 €."
                },
                {
                    "questionNumber": 7,
                    ...
                    "correction": " Le ticket de caisse détaille les achats, les taxes payées et le mode de règlement. Il est indispensable pour effectuer un échange, obtenir un remboursement ou faire valoir une garantie."
                },
                {
                    "questionNumber": 8,
                    ...
                    "correction": " Pour passer d'un pourcentage à un nombre décimal, on divise par 100. Calcul : 5,5 / 100 = 0,055. Cette valeur est utilisée pour multiplier directement les montants lors des calculs de taxes."
                },
                {
                    "questionNumber": 9,
                    ...
                    "correction": " Une remise est un geste commercial (soldes, fidélité, défaut mineur). Elle se déduit du prix de vente pour obtenir le prix net à payer."
                },
                {
                    "questionNumber": 10,
                    ...
                    "correction": " Le 'Net à payer' est le résultat final de tous les calculs (HT + TVA - Remises). C'est le montant effectif qui sortira du portefeuille du client."
                },
                {
                    "questionNumber": 11,
                    ...
                    "correction": " On applique la formule (Prix HT x Taux). Calcul : 200 € x 0,20 = 40 €. Le prix TTC serait alors de 240 €."
                },
                {
                    "questionNumber": 12,
                    ...
                    "correction": " Puisque 10 % correspond à la fraction 10/100 ou 1/10, calculer 10 % d'une valeur revient à la diviser par 10. Exemple : pour 150 € HT, la TVA est de 15 €."
                },
                {
                    "questionNumber": 13,
                    ...
                    "correction": " Calcul de l'augmentation : 100 € x 0,05 = 5 €. On ajoute cette somme au prix initial : 100 + 5 = 105 €. En une seule étape, on peut multiplier par 1,05."
                },
                {
                    "questionNumber": 14,
                    ...
                    "correction": " La facture proforma permet au client de connaître les conditions précises de vente avant de confirmer sa commande. Elle n'a pas de valeur comptable finale mais sert de base à l'accord."
                },
                {
                    "questionNumber": 15,
                    ...
                    "correction": " La monnaie rendue est la différence entre la somme donnée par le client et le prix TTC. Calcul : Somme donnée - Prix TTC = Monnaie à rendre."
                },
                {
                    "questionNumber": 16,
                    ...
                    "correction": " La marge brute (ou bénéfice) se calcule en faisant la différence entre le prix de vente et le prix d'achat. Calcul : 15 € - 10 € = 5 €."
                },
                {
                    "questionNumber": 17,
                    ...
                    "correction": " En France, le taux normal est de 20 %. Il existe des taux réduits : 10 % (restauration, transports), 5,5 % (produits alimentaires de base, livres) et 2,1 % (médicaments remboursés)."
                },
                {
                    "questionNumber": 18,
                    ...
                    "correction": " Le crédit (ou paiement différé) permet d'obtenir un bien tout de suite et de le payer plus tard, souvent en plusieurs fois (mensualités), parfois avec des intérêts supplémentaires."
                },
                {
                    "questionNumber": 19,
                    ...
                    "correction": " 25 % signifie 25/100. En divisant le numérateur et le dénominateur par 25, on obtient la fraction simplifiée 1/4. C'est le quart de l'unité."
                },
                {
                    "questionNumber": 20,
                    ...
                    "correction": " Une réduction de 50 % revient à diviser le prix par deux. Calcul : 40 € / 2 = 20 €. C'est la moitié du prix initial."
                }
            ]
        },
        # =========================================================================
            ...
            "questions": [
                {
                    ...
                    "correction": " Le périmètre est la longueur du contour. Pour un carré, les 4 côtés sont égaux, donc P = c + c + c + c = 4 x c."
                },
                {
                    "questionNumber": 22,
                    ...
                    "correction": " L'aire d'un rectangle se calcule en multipliant ses deux dimensions : Longueur (L) x largeur (l). Le résultat s'exprime en unités de surface (cm², m², etc.)."
                },
                {
                    "questionNumber": 23,
                    ...
                    "correction": " C'est une propriété fondamentale de la géométrie : dans n'importe quel triangle, si on additionne la mesure des trois angles, on obtient toujours 180°."
                },
                {
                    "questionNumber": 24,
                    ...
                    "correction": " Un triangle rectangle possède un angle de 90°. Le côté opposé à cet angle s'appelle l'hypoténuse. On utilise le théorème de Pythagore dans ce type de triangle."
                },
                {
                    "questionNumber": 25,
                    ...
                    "correction": " Pi (π) est un nombre irrationnel. On utilise généralement la valeur approchée 3,14 pour calculer le périmètre (2πR) ou l'aire (πR²) d'un cercle."
                },
                {
                    "questionNumber": 26,
                    ...
                    "correction": " Dans un triangle équilatéral, tous les côtés sont égaux et tous les angles mesurent 60°. Il possède trois axes de symétrie."
                },
                {
                    "questionNumber": 27,
                    ...
                    "correction": " Formule du périmètre : 2 x π x R. Calcul : 2 x 3 x 5 = 30 cm. Si on utilisait la valeur précise de Pi, on obtiendrait environ 31,4 cm."
                },
                {
                    "questionNumber": 28,
                    ...
                    "correction": " L'aire d'un triangle correspond à la moitié de l'aire du rectangle qui le contiendrait. Formule : (Base x Hauteur) / 2."
                },
                {
                    "questionNumber": 29,
                    ...
                    "correction": " Le périmètre du rectangle est P = (Longueur + largeur) x 2. Calcul : (10 + 4) x 2 = 14 x 2 = 28 cm."
                },
                {
                    "questionNumber": 30,
                    ...
                    "correction": " L'aire du carré est Aire = Côté x Côté (ou Côté²). Calcul : 6 cm x 6 cm = 36 cm²."
                },
                {
                    "questionNumber": 31,
                    ...
                    "correction": " Le parallélogramme a ses côtés opposés parallèles et de même longueur. Le rectangle, le losange et le carré sont des parallélogrammes particuliers."
                },
                {
                    "questionNumber": 32,
                    ...
                    "correction": " 'Hexa' signifie 6 en grec. Un hexagone est donc une figure plane à 6 côtés. La France est souvent appelée l'Hexagone à cause de sa forme géographique."
                },
                {
                    "questionNumber": 33,
                    ...
                    "correction": " Pythagore énonce que le carré de la longueur de l'hypoténuse est égal à la somme des carrés des longueurs des deux autres côtés."
                },
                {
                    "questionNumber": 34,
                    ...
                    "correction": " Un angle droit est formé par deux droites perpendiculaires. Il correspond au quart d'un tour complet de cercle (360 / 4 = 90)."
                },
                {
                    "questionNumber": 35,
                    ...
                    "correction": " Le rayon (R) est la distance constante entre le centre et n'importe quel point du cercle. Le diamètre (D) est égal à deux fois le rayon (D = 2R)."
                },
                {
                    "questionNumber": 36,
                    ...
                    "correction": " Formule de l'aire du disque : π x R². Calcul : 3,14 x 10² = 3,14 x 100 = 314 cm²."
                },
                {
                    "questionNumber": 37,
                    ...
                    "correction": " Un angle est dit 'obtus' si sa mesure est comprise entre 90° et 180°. S'il est plus petit que 90°, il est dit 'aigu'."
                },
                {
                    "questionNumber": 38,
                    ...
                    "correction": " Demi-périmètre (L+l) = 20 / 2 = 10 cm. Si la longueur L = 6, alors la largeur l = 10 - 6 = 4 cm."
                },
                {
                    "questionNumber": 39,
                    ...
                    "correction": " Le triangle est le polygone ayant le plus petit nombre de côtés. Il possède également trois sommets et trois angles."
                },
                {
                    "questionNumber": 40,
                    ...
                    "correction": " Deux droites sont perpendiculaires si elles se coupent en formant quatre angles de 90°. On utilise l'équerre pour vérifier la perpendicularité."
                }
            ]
        },
        # =========================================================================
            ...
            "questions": [
                {
                    ...
                    "correction": " La moyenne est l'indicateur de tendance centrale le plus utilisé. On additionne toutes les données collectées et on divise le résultat par le nombre total d'individus (N)."
                },
                {
                    "questionNumber": 42,
                    ...
                    "correction": " Pour un dé équilibré, chaque face a la même chance de sortir. Il y a 1 résultat favorable (le 4) sur 6 résultats possibles au total. La probabilité est donc 1/6."
                },
                {
                    "questionNumber": 43,
                    ...
                    "correction": " L'étendue mesure la dispersion des données. Elle se calcule en faisant : Plus grande valeur - Plus petite valeur. Une étendue faible signifie que les données sont proches les unes des autres."
                },
                {
                    "questionNumber": 44,
                    ...
                    "correction": " En mathématiques, la probabilité d'un événement est un nombre compris entre 0 et 1. Si l'événement ne peut jamais se produire, sa probabilité est de 0 (soit 0 %)."
                },
                {
                    "questionNumber": 45,
                    ...
                    "correction": " L'effectif total (souvent noté N) correspond à la somme de tous les effectifs individuels. C'est la taille globale de la population ou de l'échantillon étudié."
                },
                {
                    "questionNumber": 46,
                    ...
                    "correction": " Dans un jeu de 32 cartes, il y a 4 couleurs (Cœur, Carreau, Pique, Trèfle) avec 8 cartes par couleur. La probabilité de tirer un cœur est de 8/32, ce qui se simplifie en 1/4 (25 %)."
                },
                {
                    "questionNumber": 47,
                    ...
                    "correction": " Le mode est la valeur dont l'effectif est le plus grand. C'est l'indication du résultat le plus fréquent ou le plus 'populaire' dans la distribution."
                },
                {
                    "questionNumber": 48,
                    ...
                    "correction": " Comme il est certain que l'un des résultats possibles va se produire, si on additionne les chances de chaque issue, on arrive obligatoirement à 1 (soit 100 % de probabilité)."
                },
                {
                    "questionNumber": 49,
                    ...
                    "correction": " La fréquence f = n / N. C'est un nombre entre 0 et 1 qui exprime la part de la valeur dans la population. On multiplie par 100 pour l'avoir en pourcentage."
                },
                {
                    "questionNumber": 50,
                    ...
                    "correction": " Une expérience est aléatoire si on connaît toutes les issues possibles (ex: 1, 2, 3, 4, 5, 6 au dé) mais qu'il est impossible de savoir laquelle va sortir avant de réaliser l'expérience."
                },
                {
                    "questionNumber": 51,
                    ...
                    "correction": " Sur une pièce équilibrée, il y a 2 issues possibles (Pile ou Face). Chaque issue a 1 chance sur 2. En décimal, 1/2 = 0,5 (ou 50 %)."
                },
                {
                    "questionNumber": 52,
                    ...
                    "correction": " On fait la somme : 10 + 12 + 14 = 36. On divise par le nombre de notes : 36 / 3 = 12. La moyenne est donc 12."
                },
                {
                    "questionNumber": 53,
                    ...
                    "correction": " Dans ce graphique, la hauteur de chaque bâton est proportionnelle à l'effectif (ou à la fréquence) de la valeur représentée. Cela permet de comparer visuellement les données."
                },
                {
                    "questionNumber": 54,
                    ...
                    "correction": " Un événement certain se produit dans tous les cas. Sa probabilité est donc maximale, soit 1 (ce qui correspond à 100 % de chances)."
                },
                {
                    "questionNumber": 55,
                    ...
                    "correction": " Pour trouver la médiane, on range d'abord les valeurs dans l'ordre croissant. La médiane est la valeur du milieu : il y a autant de données plus petites que de données plus grandes."
                },
                {
                    "questionNumber": 56,
                    ...
                    "correction": " Nombre total de billes = 3 + 7 = 10. Billes rouges favorables = 3. Probabilité = 3/10 = 0,3 (soit 30 %)."
                },
                {
                    "questionNumber": 57,
                    ...
                    "correction": " 100 % correspond à la fraction 100/100, soit l'unité entière. Cela désigne donc tous les individus de la série sans exception."
                },
                {
                    "questionNumber": 58,
                    ...
                    "correction": " Le disque entier représente la totalité de l'effectif (100 %). Les angles des secteurs sont calculés pour que leur somme fasse 360°, mais le total des pourcentages reste 100 %."
                },
                {
                    "questionNumber": 59,
                    ...
                    "correction": " On cherche le max (22) et le min (12). On fait la soustraction : 22 - 12 = 10. L'étendue thermique est donc de 10°C."
                },
                {
                    "questionNumber": 60,
                    ...
                    "correction": " L'événement contraire comprend toutes les issues qui ne réalisent pas l'événement initial. Si on ne tire pas un pair (2, 4, 6), on tire forcément un impair (1, 3, 5)."
                }
            ]
        },
        # =========================================================================
            ...
            "questions": [
                {
                    ...
                    "correction": " Pour isoler x, on déplace le +5 de l'autre côté de l'égalité en changeant son signe. Calcul : x = 12 - 5 = 7. Vérification : 7 + 5 donne bien 12."
                },
                {
                    "questionNumber": 62,
                    ...
                    "correction": " Pour isoler x quand il est multiplié par un nombre, on divise de l'autre côté par ce même nombre. Calcul : x = 15 / 3 = 5. Vérification : 3 x 5 = 15."
                },
                {
                    "questionNumber": 63,
                    ...
                    "correction": " Une fonction affine est représentée par une droite qui ne passe pas forcément par l'origine. 'a' est le coefficient directeur (la pente) et 'b' est l'ordonnée à l'origine."
                },
                {
                    "questionNumber": 64,
                    ...
                    "correction": " Calculer l'image d'un nombre consiste à remplacer x par sa valeur dans la fonction. Calcul : 2 x 4 = 8. On dit que 8 est l'image de 4 par f."
                },
                {
                    "questionNumber": 65,
                    ...
                    "correction": " Une fonction linéaire (type f(x) = ax) traduit une situation de proportionnalité. Sa droite passe obligatoirement par le point (0,0) car si x = 0, alors f(0) = 0."
                },
                {
                    "questionNumber": 66,
                    ...
                    "correction": " Quand on additionne deux nombres négatifs, on additionne leurs valeurs absolues et on garde le signe moins. Calcul : 4 + 3 = 7, donc le résultat est -7."
                },
                {
                    "questionNumber": 67,
                    ...
                    "correction": " Règle des signes pour la multiplication : le produit de deux nombres de même signe est toujours positif. Calcul : 2 x 5 = 10, et moins par moins donne plus."
                },
                {
                    "questionNumber": 68,
                    ...
                    "correction": " L'inconnue est la lettre (généralement x ou y) dont on cherche la valeur numérique pour que l'égalité soit vraie."
                },
                {
                    "questionNumber": 69,
                    ...
                    "correction": " On peut additionner les termes qui ont la même lettre. Calcul : (3 + 2 - 1)x = 4x. Rappelez-vous que '-x' est équivalent à '-1x'."
                },
                {
                    "questionNumber": 70,
                    ...
                    "correction": " Elever un nombre au carré consiste à le multiplier par lui-même. Calcul : 5 x 5 = 25. Ne pas confondre avec 5 x 2."
                },
                {
                    "questionNumber": 71,
                    ...
                    "correction": " 1) 2x = 9 - 1 = 8. 2) x = 8 / 2 = 4. La solution de l'équation est 4."
                },
                {
                    "questionNumber": 72,
                    ...
                    "correction": " On remplace les lettres par les chiffres. Calcul : 3 + (2 x 4) = 3 + 8 = 11. On respecte la priorité de la multiplication."
                },
                {
                    "questionNumber": 73,
                    ...
                    "correction": " L'inverse d'un nombre x est 1/x. Pour 2, l'inverse est 1/2, soit 0,5 en écriture décimale."
                },
                {
                    "questionNumber": 74,
                    ...
                    "correction": " Une fonction est croissante si, lorsque les valeurs de x augmentent, les valeurs de y augmentent également. La pente de la droite (ou de la tangente) est alors positive."
                },
                {
                    "questionNumber": 75,
                    ...
                    "correction": " Dans f(x) = ax + b, 'b' est l'ordonnée à l'origine. C'est la valeur de y au point où la droite coupe l'axe vertical (quand x = 0)."
                },
                {
                    "questionNumber": 76,
                    ...
                    "correction": " L'opération inverse de la division est la multiplication. On multiplie 10 par 2 pour isoler x. Calcul : x = 10 x 2 = 20."
                },
                {
                    "questionNumber": 77,
                    ...
                    "correction": " (-4)² = (-4) x (-4). Moins par moins donne plus. Le carré d'un nombre réel est toujours positif. Le résultat est donc 16."
                },
                {
                    "questionNumber": 78,
                    ...
                    "correction": " Le triple signifie multiplier par 3. 'x + 3' est l'augmentation de 3 et 'x³' est le cube de x."
                },
                {
                    "questionNumber": 79,
                    ...
                    "correction": " On utilise la distributivité : on multiplie le chiffre 2 par chaque terme dans la parenthèse. Calcul : (2 x x) + (2 x 3) = 2x + 6."
                },
                {
                    "questionNumber": 80,
                    ...
                    "correction": " 10³ = 10 x 10 x 10 = 1 000. L'exposant indique le nombre de zéros à placer après le 1."
                }
            ]
        },
        # =========================================================================
            ...
            "questions": [
                {
                    ...
                    "correction": " Le préfixe 'kilo' signifie mille. C'est l'unité de base de masse dans le système international. Pour convertir des kg en g, on multiplie par 1000."
                },
                {
                    "questionNumber": 82,
                    ...
                    "correction": " L'intensité (débit d'électrons) se mesure en Ampères. Le Volt mesure la tension et le Watt mesure la puissance."
                },
                {
                    "questionNumber": 83,
                    ...
                    "correction": " 1 heure = 60 minutes. Donc 2 heures = 120 minutes. Une demi-heure = 30 minutes. Calcul : 120 + 30 = 150 minutes."
                },
                {
                    "questionNumber": 84,
                    ...
                    "correction": " La puissance électrique (P) est le produit de la tension par l'intensité (P = U x I). Elle s'exprime en Watts. On l'utilise pour indiquer la consommation des appareils."
                },
                {
                    "questionNumber": 85,
                    ...
                    "correction": " Dans le tableau des longueurs, le millimètre est l'unité juste à droite du centimètre. Pour passer de l'un à l'autre, on multiplie donc par 10. Exemple : 5 cm = 50 mm."
                },
                {
                    "questionNumber": 86,
                    ...
                    "correction": " C'est une correspondance de référence : 1 dm³ d'eau = 1 litre = 1 kg. Attention, cette égalité n'est vraie que pour l'eau (la densité de l'huile ou du métal est différente)."
                },
                {
                    "questionNumber": 87,
                    ...
                    "correction": " Le système de mesure du temps est sexagésimal (base 60). Une minute vaut 60 secondes et une heure vaut 3600 secondes (60x60)."
                },
                {
                    "questionNumber": 88,
                    ...
                    "correction": " Une surface se mesure en deux dimensions (longueur x largeur). L'unité de base est le m². Pour les terrains agricoles, on utilise aussi l'hectare (ha) qui vaut 10 000 m²."
                },
                {
                    "questionNumber": 89,
                    ...
                    "correction": " On multiplie par 1000. Calcul : 1,5 x 1000 = 1500 g. C'est utile pour les recettes de cuisine ou les pesées en atelier."
                },
                {
                    "questionNumber": 90,
                    ...
                    "correction": " La tension électrique (différence de potentiel) se mesure avec un voltmètre branché en dérivation. En France, la tension domestique est de 230 V."
                },
                {
                    "questionNumber": 91,
                    ...
                    "correction": " Le préfixe 'milli' signifie millième. Il faut donc 1000 millilitres pour constituer un litre entier. C'est l'équivalent de 1 cm³."
                },
                {
                    "questionNumber": 92,
                    ...
                    "correction": " Un volume se mesure en trois dimensions (L x l x h). L'unité de référence est le m³. On utilise aussi beaucoup le litre pour les liquides."
                },
                {
                    "questionNumber": 93,
                    ...
                    "correction": " Pour passer des mètres aux centimètres, on multiplie par 100 (on décale la virgule de deux rangs vers la droite). Calcul : 2,5 x 100 = 250 cm."
                },
                {
                    "questionNumber": 94,
                    ...
                    "correction": " La balance mesure la masse (en kg ou g). Le pèse-personne ou la balance de cuisine en sont des exemples courants."
                },
                {
                    "questionNumber": 95,
                    ...
                    "correction": " Le chronomètre sert à mesurer le temps écoulé entre un début et une fin. Il est très précis (souvent au centième de seconde près)."
                },
                {
                    "questionNumber": 96,
                    ...
                    "correction": " En France et dans la plupart des pays, on utilise l'échelle Celsius (°C). L'eau gèle à 0°C et bout à 100°C (à pression normale)."
                },
                {
                    "questionNumber": 97,
                    ...
                    "correction": " C'est le lien entre le volume et la capacité : 1 L = 1 dm³. Cela signifie qu'un cube de 10 cm de côté peut contenir exactement 1 litre de liquide."
                },
                {
                    "questionNumber": 98,
                    ...
                    "correction": " Un cube possède 8 coins (sommets), 12 arêtes (les barres) et 6 faces (les carrés qui l'entourent)."
                },
                {
                    "questionNumber": 99,
                    ...
                    "correction": " Lorsque le total des minutes atteint ou dépasse 60, on doit retrancher 60 aux minutes et ajouter 1 au compteur des heures. Exemple : 1h45 + 30min = 1h75 = 2h15."
                },
                {
                    "questionNumber": 100,
                    ...
                    "correction": " Comme l'indique le nom 'mille-mètre', il faut 1000 petites graduations de mm pour faire un mètre entier. 1 m = 10 dm = 100 cm = 1000 mm."
                }
            ]
        }
    }
