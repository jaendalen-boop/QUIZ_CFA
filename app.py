...
QUIZZES = {
    ...
    "cap_employe_polyvalent_commerce_100": {
        "title": "CAP Employé Polyvalent du Commerce",
    ...
    "cap_macon_100": {
        "title": "CAP Maçon",
        "description": "CAP Maçon.",
        "data": quiz_macon_data,
        "icon": "🧱",
        "color": "#95a5a6",
    },
    "cap_meca_vp_100": {
        "title": "CAP Mécanique VP",
        "description": "CAP Mécanique.",
        "data": quiz_meca_vp_data,
        "icon": "🔩",
        "color": "#34495e",
    },
    "cap_menuisier_fabricant_100": {
        "title": "CAP Menuisier Fabricant",
    ...
    "cap_peintre_100": {
        ...
        "description": "CAP Peintre et applicateur de revètement.",
        "data": quiz_peintre_data,
        "icon": "🎨",
        "color": "#673ab7",
    },
    "cap_peinture_carrosserie_100": {
        "title": "CAP Peinture en Carrosserie",
    ...
    "cap_serrurerier_metallier_100": {
        "title": "CAP Serrurerie-Métallier",
