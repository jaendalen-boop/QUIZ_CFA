quiz_data = {
    ...
    "themes": {
        ...
        # =========================================================================
        1: {
            "name": "THÈME 1 : LA FRANCE DE LA RÉVOLUTION À LA Ve RÉPUBLIQUE",
            "questions": [
                {
                    "questionNumber": 1,
                    ...
                    "correction": "Le 14 juillet 1789, le peuple parisien s'empare de la Bastille, une prison royale qui symbolisait l'arbitraire et le pouvoir absolu du roi. Cet acte marque l'entrée du peuple sur la scène politique et le début de la fin de l'Ancien Régime."
                },
                {
                    "questionNumber": 2,
                    ...
                    "correction": "Écrit par Rouget de Lisle en 1792 dans un contexte de guerre, ce chant patriotique est devenu l'hymne officiel. Il symbolise la défense des valeurs de la République et l'unité de la Nation face aux menaces."
                },
                {
                    "questionNumber": 3,
                    ...
                    "correction": "Adoptée le 26 août 1789, la DDHC est le texte pilier qui met fin à la société d'ordres et de privilèges. Elle pose les bases d'une société nouvelle fondée sur la liberté, l'égalité et la souveraineté du peuple."
                },
                {
                    "questionNumber": 4,
                    ...
                    "correction": "Napoléon Bonaparte, après avoir pris le pouvoir par un coup d'État en 1799, transforme la République en Empire en 1804. Il réorganise l'État avec des institutions durables (lycées, préfets, Code civil)."
                },
                {
                    "questionNumber": 5,
                    ...
                    "correction": "C'est sous la IIe République, en 1848, que le vote devient un droit pour tous les hommes majeurs, sans condition de richesse. C'est une étape majeure vers la démocratie, même si les femmes en restent exclues."
                },
                {
                    "questionNumber": 6,
                    ...
                    "correction": "À la Libération, une ordonnance du Général de Gaulle accorde enfin le droit de vote aux femmes. Elles voteront pour la première fois lors des élections municipales d'avril 1945, rattrapant ainsi un long retard démocratique."
                },
                {
                    "questionNumber": 7,
                    ...
                    "correction": "Rappelé au pouvoir lors de la crise algérienne, Charles de Gaulle fait adopter une nouvelle Constitution par référendum en 1958. Elle renforce le pouvoir exécutif et définit le régime politique actuel de la France."
                },
                {
                    "questionNumber": 8,
                    ...
                    "correction": "Cette devise héritée de la Révolution française apparaît sur les bâtiments publics. La liberté et l'égalité sont des droits, tandis que la fraternité est un devoir moral qui fonde la solidarité nationale."
                },
                {
                    "questionNumber": 9,
                    ...
                    "correction": "Marianne est l'allégorie de la République française. Son buste est présent dans toutes les mairies. Le bonnet phrygien qu'elle porte était, dans l'Antiquité, le symbole des esclaves affranchis."
                },
                {
                    "questionNumber": 10,
                    ...
                    "correction": "Cette loi est le fondement de la laïcité en France. Elle garantit la liberté de conscience et le libre exercice des cultes, mais l'État ne reconnaît, ne salarie ni ne subventionne aucune religion."
                },
                {
                    "questionNumber": 11,
                    ...
                    "correction": "Créée juste après la Seconde Guerre mondiale, la Sécurité sociale repose sur un principe de solidarité. Elle protège les Français contre les risques de la vie : maladie, accidents du travail, vieillesse (retraites) et charges familiales."
                },
                {
                    "questionNumber": 12,
                    ...
                    "correction": "La Ve République est un régime parlementaire stable avec un rôle central accordé au Président de la République. Elle a été créée pour mettre fin à l'instabilité ministérielle du régime précédent."
                },
                {
                    "questionNumber": 13,
                    ...
                    "correction": "Jules Ferry a voulu faire de l'école le lieu d'apprentissage des valeurs républicaines. En la rendant gratuite et obligatoire, il a permis l'alphabétisation massive de la population française."
                },
                {
                    "questionNumber": 14,
                    ...
                    "correction": "Le référendum permet au peuple d'exercer directement sa souveraineté en votant pour ou contre un texte proposé par le président. C'est un outil démocratique puissant."
                },
                {
                    "questionNumber": 15,
                    ...
                    "correction": "La Constitution est la loi suprême d'un pays. Elle organise les pouvoirs publics et garantit les libertés fondamentales. Tout citoyen doit la respecter et la connaître."
                },
                {
                    "questionNumber": 16,
                    ...
                    "correction": "L'abolition de la peine de mort a été portée par Robert Badinter, alors garde des Sceaux, sous la présidence de François Mitterrand. C'est une grande avancée humaniste pour la justice française."
                },
                {
                    "questionNumber": 17,
                    ...
                    "correction": "Mai 68 a débuté comme une révolte étudiante avant de devenir une grève générale ouvrière. Cette crise a bousculé les traditions et a permis une libération des mœurs et un renforcement des droits syndicaux."
                },
                {
                    "questionNumber": 18,
                    ...
                    "correction": "L'Arc de Triomphe a été commandé par Napoléon après sa victoire à Austerlitz en 1805. Il rend hommage à la Grande Armée et abrite aujourd'hui la tombe du Soldat inconnu."
                },
                {
                    "questionNumber": 19,
                    ...
                    "correction": "Le président est élu au suffrage universel direct pour 5 ans. Il nomme le Premier ministre, préside le Conseil des ministres et assure le respect de la Constitution."
                },
                {
                    "questionNumber": 20,
                    ...
                    "correction": "Le drapeau tricolore est né de la Révolution. Le blanc est la couleur du roi, entouré par le bleu et le rouge qui sont les couleurs de la ville de Paris. Leur réunion symbolise l'union nationale."
                }
            ]
        },
        # =========================================================================
            ...
            "questions": [
                {
                    ...
                    "correction": "L'urbanisation est mondiale : aujourd'hui, plus d'un humain sur deux vit en ville. Cela s'explique par la recherche d'emploi, de services (santé, éducation) et de loisirs."
                },
                {
                    "questionNumber": 22,
                    ...
                    "correction": "Une métropole est une grande ville qui concentre les activités de commandement (politique, économique, culturel) et qui rayonne sur les territoires qui l'entourent."
                },
                {
                    "questionNumber": 23,
                    ...
                    "correction": "La périurbanisation est l'étalement des villes. On y trouve beaucoup de maisons individuelles (lotissements). Cela augmente les temps de transport quotidiens vers les centres-villes."
                },
                {
                    "questionNumber": 24,
                    ...
                    "correction": "Le développement durable doit être efficace économiquement, équitable socialement et tolérable pour l'environnement afin de préserver les ressources pour les générations futures."
                },
                {
                    "questionNumber": 25,
                    ...
                    "correction": "Le CBD (Central Business District) est le cœur financier de la métropole. On y trouve des tours de bureaux et des sièges sociaux d'entreprises. La Défense à Paris en est l'exemple français."
                },
                {
                    "questionNumber": 26,
                    ...
                    "correction": "Le tri sélectif permet de transformer les matières usagées (verre, papier, plastique) en nouveaux objets, économisant ainsi les ressources naturelles et l'énergie."
                },
                {
                    "questionNumber": 27,
                    ...
                    "correction": "Les transports doux ne rejettent pas de gaz à effet de serre. Ils sont encouragés en ville par la création de pistes cyclables et de zones piétonnes."
                },
                {
                    "questionNumber": 28,
                    ...
                    "correction": "Un éco-quartier intègre dès sa construction des critères écologiques : économies d'eau et d'énergie, espaces verts, gestion des déchets et mixité sociale."
                },
                {
                    "questionNumber": 29,
                    ...
                    "correction": "Le CO2 est rejeté par la combustion des énergies fossiles (pétrole, charbon, gaz). En s'accumulant dans l'atmosphère, il retient la chaleur du soleil (effet de serre)."
                },
                {
                    "questionNumber": 30,
                    ...
                    "correction": "La mobilité concerne les trajets domicile-travail, les loisirs et les vacances. Organiser une mobilité durable est un enjeu majeur pour les villes de demain."
                },
                {
                    "questionNumber": 31,
                    ...
                    "correction": "Historiquement, les progrès agricoles ont libéré de la main-d'œuvre qui est partie travailler dans les usines en ville. Ce mouvement a transformé la France au XXe siècle."
                },
                {
                    "questionNumber": 32,
                    ...
                    "correction": "Le pilier social vise à garantir à tous l'accès à l'éducation, à la santé, au logement et à lutter contre la pauvreté pour assurer la cohésion de la société."
                },
                {
                    "questionNumber": 33,
                    ...
                    "correction": "L'étalement urbain grignote les terres agricoles et les espaces naturels. Il oblige à construire de nouvelles infrastructures coûteuses et favorise l'usage de la voiture."
                },
                {
                    "questionNumber": 34,
                    ...
                    "correction": "Le recyclage (boucle fermée) économise l'extraction de nouvelles ressources. Par exemple, recycler l'aluminium coûte beaucoup moins d'énergie que d'en produire du nouveau."
                },
                {
                    "questionNumber": 35,
                    ...
                    "correction": "La mixité sociale consiste à faire cohabiter des personnes de revenus et d'origines différents dans un même quartier pour éviter la création de 'ghettos'."
                },
                {
                    "questionNumber": 36,
                    ...
                    "correction": "Les parcs et jardins urbains servent de 'poumons' aux villes, régulent la température lors des canicules et offrent des lieux de détente essentiels aux citadins."
                },
                {
                    "questionNumber": 37,
                    ...
                    "correction": "Les transports routiers et aériens sont les principaux émetteurs de polluants atmosphériques et de gaz à effet de serre. Ils sont aussi une source importante de nuisances sonores."
                },
                {
                    "questionNumber": 38,
                    ...
                    "correction": "Une agglomération est un ensemble de communes dont les constructions se touchent. On parle d'un pôle urbain qui centralise les services et les emplois."
                },
                {
                    "questionNumber": 39,
                    ...
                    "correction": "Une bonne isolation thermique évite les déperditions de chaleur. C'est l'un des moyens les plus efficaces pour réduire ses factures et son impact écologique."
                },
                {
                    "questionNumber": 40,
                    ...
                    "correction": "L'étalement urbain signifie que la ville s'étend horizontalement sur les champs. Cela fragmente les paysages naturels et rend l'usage de la voiture quasi indispensable."
                }
            ]
        },
        # =========================================================================
            ...
            "questions": [
                {
                    ...
                    "correction": "L'Atlantique est l'espace majeur des échanges entre l'Europe et l'Amérique du Nord. C'est sur cet océan que se situent aussi les Antilles françaises et la Guyane."
                },
                {
                    "questionNumber": 42,
                    ...
                    "correction": " Depuis le départ du Royaume-Uni (Brexit), l'UE compte 27 pays. C'est un espace de paix, de libre-échange et de solidarité politique unique au monde."
                },
                {
                    "questionNumber": 43,
                    ...
                    "correction": " Bruxelles accueille la Commission européenne et le Conseil. Strasbourg est le siège du Parlement européen, où se réunissent les députés élus."
                },
                {
                    "questionNumber": 44,
                    ...
                    "correction": " L'euro facilite les échanges et les voyages entre les pays membres. Les pays utilisant l'euro forment ce que l'on appelle la 'Zone Euro'."
                },
                {
                    "questionNumber": 45,
                    ...
                    "correction": " Les DROM (Guadeloupe, Guyane, Martinique, Mayotte, La Réunion) font partie intégrante de la France et de l'UE. Les lois françaises s'y appliquent comme en métropole."
                },
                {
                    "questionNumber": 46,
                    ...
                    "correction": " L'Allemagne est le moteur industriel et financier de l'Europe. Avec la France, elle forme le 'couple franco-allemand' qui mène souvent l'Union européenne."
                },
                {
                    "questionNumber": 47,
                    ...
                    "correction": " Les Pyrénées forment une frontière naturelle entre les deux pays. C'est une zone de passage mais aussi un espace naturel protégé."
                },
                {
                    "questionNumber": 48,
                    ...
                    "correction": " La Seine est l'axe historique de développement de Paris. Elle permet le transport de marchandises et est un lieu touristique mondial majeur."
                },
                {
                    "questionNumber": 49,
                    ...
                    "correction": " La Méditerranée est un carrefour culturel et économique entre l'Europe, l'Afrique et le Moyen-Orient. C'est aussi une zone très touristique."
                },
                {
                    "questionNumber": 50,
                    ...
                    "correction": " Le drapeau bleu comporte 12 étoiles d'or disposées en cercle. Le chiffre 12 symbolise la perfection et l'unité, et non le nombre de pays membres."
                },
                {
                    "questionNumber": 51,
                    ...
                    "correction": " Le Royaume-Uni a choisi de sortir de l'UE suite à un référendum. Cela a entraîné le rétablissement de contrôles aux frontières et de nouvelles relations commerciales."
                },
                {
                    "questionNumber": 52,
                    ...
                    "correction": " L'allemand est la langue maternelle la plus répandue car l'Allemagne est le pays le plus peuplé de l'Union européenne. L'anglais reste cependant la langue de communication privilégiée."
                },
                {
                    "questionNumber": 53,
                    ...
                    "correction": " Le Mont-Blanc (4808 m) est le point culminant de l'Europe occidentale. Les Alpes sont une chaîne de montagnes 'jeune' aux sommets élevés et pointus."
                },
                {
                    "questionNumber": 54,
                    ...
                    "correction": " La Guyane est couverte à 95 % par la forêt amazonienne. Elle accueille le centre spatial de Kourou, d'où décollent les fusées européennes Ariane."
                },
                {
                    "questionNumber": 55,
                    ...
                    "correction": " Les députés européens sont élus tous les 5 ans par les citoyens. Ils votent le budget et les lois (directives) qui s'appliquent ensuite dans tous les pays membres."
                },
                {
                    "questionNumber": 56,
                    ...
                    "correction": " Strasbourg est le symbole de la réconciliation. Outre le Parlement européen, elle abrite le Conseil de l'Europe et la Cour européenne des droits de l'homme."
                },
                {
                    "questionNumber": 57,
                    ...
                    "correction": " L'espace Schengen regroupe 29 pays (européens ou non) qui ont supprimé les contrôles à leurs frontières communes pour faciliter la circulation des personnes."
                },
                {
                    "questionNumber": 58,
                    ...
                    "correction": " La Manche est une mer étroite. Le tunnel sous la Manche relie aujourd'hui physiquement les deux pays par le train (Eurostar)."
                },
                {
                    "questionNumber": 59,
                    ...
                    "correction": " La France métropolitaine est surnommée 'l'hexagone'. C'est le plus grand territoire agricole de l'Union européenne."
                },
                {
                    "questionNumber": 60,
                    ...
                    "correction": " La Francophonie regroupe plus de 300 millions de locuteurs sur les 5 continents. C'est un espace de coopération culturelle et linguistique."
                }
            ]
        },
        # =========================================================================
            ...
            "questions": [
                {
                    ...
                    "correction": " Démocratie vient du grec 'demos' (peuple) et 'kratos' (pouvoir). Le peuple exerce ce pouvoir par ses élus (élections) ou par le référendum."
                },
                {
                    "questionNumber": 62,
                    ...
                    "correction": " La majorité civile et politique a été abaissée de 21 à 18 ans en 1974. C'est l'âge à partir duquel on peut participer à tous les scrutins."
                },
                {
                    "questionNumber": 63,
                    ...
                    "correction": " En France, le pouvoir législatif est confié au Parlement, composé de l'Assemblée nationale et du Sénat. C'est l'un des trois pouvoirs fondamentaux séparés."
                },
                {
                    "questionNumber": 64,
                    ...
                    "correction": " Les 577 députés sont élus au suffrage universel direct pour 5 ans. Ils siègent au Palais Bourbon et contrôlent l'action du gouvernement."
                },
                {
                    "questionNumber": 65,
                    ...
                    "correction": " La laïcité protège la liberté de croire ou de ne pas croire. Elle assure l'égalité de tous devant la loi, quelle que soit leur religion ou conviction spirituelle."
                },
                {
                    "questionNumber": 66,
                    ...
                    "correction": " Le vote est un droit et un devoir civique. Il permet aux citoyens de s'exprimer et de participer à la vie de la cité en choisissant ceux qui vont décider pour eux."
                },
                {
                    "questionNumber": 67,
                    ...
                    "correction": " Pour éviter les fraudes, chaque électeur doit prouver son identité. Dans les grandes communes, une pièce d'identité avec photo est obligatoire."
                },
                {
                    "questionNumber": 68,
                    ...
                    "correction": " Nommé par le président, le Premier ministre coordonne le travail des ministres et assure l'exécution des lois votées par le Parlement."
                },
                {
                    "questionNumber": 69,
                    ...
                    "correction": " Les syndicats défendent les intérêts des travailleurs (salaires, conditions de travail). Ils participent au dialogue social avec les employeurs et l'État."
                },
                {
                    "questionNumber": 70,
                    ...
                    "correction": " C'est une liberté fondamentale. On peut s'exprimer librement par la parole ou l'écrit, tant que l'on ne commet pas de délit (diffamation, incitation à la haine)."
                },
                {
                    "questionNumber": 71,
                    ...
                    "correction": " Le conseil municipal, élu par les habitants, vote les décisions locales (écoles, routes, urbanisme) et le budget de la commune."
                },
                {
                    "questionNumber": 72,
                    ...
                    "correction": " L'impôt sert à financer les services dont tout le monde bénéficie : écoles, hôpitaux, police, pompiers, routes et éclairage public."
                },
                {
                    "questionNumber": 73,
                    ...
                    "correction": " Il vérifie que les lois votées par le Parlement sont conformes à la Constitution. Il valide aussi les résultats de l'élection présidentielle."
                },
                {
                    "questionNumber": 74,
                    ...
                    "correction": " Peu importe la richesse ou l'origine, la loi protège ou punit de la même manière. C'est un principe essentiel de l'État de droit."
                },
                {
                    "questionNumber": 75,
                    ...
                    "correction": " La police et la gendarmerie veillent au respect de la loi et à la protection des citoyens et de leurs biens sur tout le territoire."
                },
                {
                    "questionNumber": 76,
                    ...
                    "correction": " Manifester est un droit démocratique. Il doit se faire de manière pacifique et être déclaré auprès de la préfecture pour assurer la sécurité."
                },
                {
                    "questionNumber": 77,
                    ...
                    "correction": " Le 11 novembre 1918 marque la fin des combats de la Première Guerre mondiale. C'est une journée de mémoire pour tous les soldats morts pour la France."
                },
                {
                    "questionNumber": 78,
                    ...
                    "correction": " C'est une élection au suffrage universel direct. Tous les 5 ans, les citoyens européens choisissent leurs représentants au Parlement européen."
                },
                {
                    "questionNumber": 79,
                    ...
                    "correction": " Être citoyen, c'est appartenir à une communauté politique. Cela donne le droit de voter mais impose aussi le respect des lois et de la solidarité."
                },
                {
                    "questionNumber": 80,
                    ...
                    "correction": " Le blanc est souvent utilisé comme symbole de paix et de pureté. Le drapeau blanc est d'ailleurs le signe universel de la reddition ou de la demande de cessez-le-feu."
                }
            ]
        },
        # =========================================================================
            ...
            "questions": [
                {
                    ...
                    "correction": " L'Asie regroupe plus de 60 % de la population mondiale, avec des géants démographiques comme la Chine et l'Inde qui dépassent chacun 1,4 milliard d'habitants."
                },
                {
                    "questionNumber": 82,
                    ...
                    "correction": " Le changement climatique actuel est dû aux activités humaines. Il provoque une hausse des températures, la fonte des glaces et une multiplication des catastrophes naturelles."
                },
                {
                    "questionNumber": 83,
                    ...
                    "correction": " La Russie s'étend sur deux continents (Europe et Asie). Elle couvre plus de 17 millions de km², ce qui représente environ 11 % des terres émergées du globe."
                },
                {
                    "questionNumber": 84,
                    ...
                    "correction": " La biodiversité comprend tous les animaux, plantes, champignons et bactéries. Elle est indispensable à l'équilibre de la vie sur Terre et à la survie humaine."
                },
                {
                    "questionNumber": 85,
                    ...
                    "correction": " L'Amazone, en Amérique du Sud, possède le plus grand débit d'eau. Son bassin versant est vital pour le climat mondial grâce à la forêt tropicale qu'il traverse."
                },
                {
                    "questionNumber": 86,
                    ...
                    "correction": " Ces énergies proviennent de sources naturelles qui ne s'épuisent pas : le soleil (solaire), le vent (éolien), l'eau (hydraulique) ou la chaleur de la terre (géothermie)."
                },
                {
                    "questionNumber": 87,
                    ...
                    "correction": " L'océan Pacifique couvre un tiers de la surface de la Terre. Il est plus grand que toutes les terres émergées réunies."
                },
                {
                    "questionNumber": 88,
                    ...
                    "correction": " L'Antarctique est un continent recouvert de glace. Il n'appartient à aucun pays et est réservé à la recherche scientifique et à la protection de la nature."
                },
                {
                    "questionNumber": 89,
                    ...
                    "correction": " L'Inde a récemment dépassé la Chine pour devenir le pays le plus peuplé. Cette population jeune est un atout économique mais pose d'immenses défis sociaux."
                },
                {
                    "questionNumber": 90,
                    ...
                    "correction": " Elle mesure la surface de terre et d'eau nécessaire pour produire ce que nous consommons et absorber nos déchets. Si tout le monde vivait comme un Français, il faudrait presque 3 planètes."
                },
                {
                    "questionNumber": 91,
                    ...
                    "correction": " La couche d'ozone nous protège des rayons UV dangereux du soleil. Elle a été endommagée par des gaz (CFC) utilisés autrefois dans les frigos et les sprays."
                },
                {
                    "questionNumber": 92,
                    ...
                    "correction": " Surnommée le 'poumon de la terre', l'Amazonie abrite des millions d'espèces. Sa déforestation menace le climat et les peuples autochtones qui y vivent."
                },
                {
                    "questionNumber": 93,
                    ...
                    "correction": " Le Japon est situé sur la 'ceinture de feu du Pacifique', au croisement de plusieurs plaques tectoniques. Les bâtiments y sont construits avec des normes parasismiques strictes."
                },
                {
                    "questionNumber": 94,
                    ...
                    "correction": " C'est pour cette raison qu'on appelle la Terre la 'planète bleue'. Les océans régulent le climat et fournissent une grande part de l'oxygène que nous respirons."
                },
                {
                    "questionNumber": 95,
                    ...
                    "correction": " Ces villes géantes (Tokyo, Mexico, Lagos) concentrent des populations et des problèmes immenses de transport, de logement et de pollution."
                },
                {
                    "questionNumber": 96,
                    ...
                    "correction": " Le Sahara traverse une dizaine de pays d'Afrique du Nord. C'est un espace de sable et de roche où les conditions de vie sont extrêmes."
                },
                {
                    "questionNumber": 97,
                    ...
                    "correction": " C'est une démarche qui mobilise les acteurs d'un territoire (maires, citoyens, entreprises) pour créer des emplois et des services sans abîmer l'environnement local."
                },
                {
                    "questionNumber": 98,
                    ...
                    "correction": " Ces réunions mondiales visent à engager les pays à réduire leurs émissions de CO2 pour limiter le réchauffement climatique à moins de 2 degrés."
                },
                {
                    "questionNumber": 99,
                    ...
                    "correction": " L'érosion est naturelle (vent, pluie) mais elle est aggravée par l'homme (déforestation, agriculture intensive). Cela rend les terres moins fertiles."
                },
                {
                    "questionNumber": 100,
                    ...
                    "correction": " Éteindre la lumière, trier ses déchets, ne pas gaspiller l'eau ou manger local sont des exemples d'écogestes qui, multipliés, ont un impact réel."
                }
            ]
        }
    }
